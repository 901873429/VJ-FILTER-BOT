...
API_ID = int(environ.get('API_ID', '29207312'))
API_HASH = environ.get('API_HASH', 'ec5e48075b6bc426000c962d4459c797')
BOT_TOKEN = environ.get('BOT_TOKEN', "7649514264:AAHqoeVJOArIPrpRsP_Bd2txD_YDphzsgu4")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7091603943').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002619613654'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002429835790').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002203637758')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002668946237')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://animehindi27771:<db_password>@cluster0.gipu5i1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "animehindi27771)
